...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Portal: renderiza fuera del motion.header para evitar que
          transform/backdrop-filter del padre rompa el fixed positioning */}
      {mounted && open && createPortal(
        <div
          id="mobile-nav"
          className="fixed inset-0 z-[200] bg-invictus-black md:hidden"
          style={{
